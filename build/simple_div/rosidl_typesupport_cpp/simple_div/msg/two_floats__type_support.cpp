...
static const _TwoFloats_type_support_symbol_names_t _TwoFloats_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, simple_div, msg, TwoFloats)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, simple_div, msg, TwoFloats)),
  }
};
...
{
  return &::simple_div::msg::rosidl_typesupport_cpp::TwoFloats_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, simple_div, msg, TwoFloats)() {
  return get_message_type_support_handle<simple_div::msg::TwoFloats>();
}
