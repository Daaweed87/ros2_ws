...
#include "simple_div/msg/detail/two_floats__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = simple_div::msg::TwoFloats;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const simple_div::msg::TwoFloats *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<simple_div::msg::TwoFloats *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_simple_div
const rosidl_message_type_support_t *
get_message_type_support_handle<simple_div::msg::TwoFloats>()
{
  return &simple_div::msg::typesupport_fastrtps_cpp::_TwoFloats__handle;
}
