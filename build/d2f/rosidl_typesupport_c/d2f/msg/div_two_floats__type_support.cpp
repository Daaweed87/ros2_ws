...
static const _DivTwoFloats_type_support_symbol_names_t _DivTwoFloats_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, d2f, msg, DivTwoFloats)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, d2f, msg, DivTwoFloats)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, d2f, msg, DivTwoFloats)() {
  return &::d2f::msg::rosidl_typesupport_c::DivTwoFloats_message_type_support_handle;
}
