...
static const _AddTwoInts2_type_support_symbol_names_t _AddTwoInts2_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_package, msg, AddTwoInts2)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_package, msg, AddTwoInts2)),
  }
};
...
{
  return &::my_package::msg::rosidl_typesupport_cpp::AddTwoInts2_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, my_package, msg, AddTwoInts2)() {
  return get_message_type_support_handle<my_package::msg::AddTwoInts2>();
}
