...
#include "my_package/msg/detail/two_floats__rosidl_typesupport_fastrtps_c.h"
...
using _TwoFloats__ros_msg_type = my_package__msg__TwoFloats;
...
size_t get_serialized_size_my_package__msg__TwoFloats(
  const void * untyped_ros_message,
...
static uint32_t _TwoFloats__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_package__msg__TwoFloats(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_package
size_t max_serialized_size_my_package__msg__TwoFloats(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_package__msg__TwoFloats;
    is_plain =
      (
...
static size_t _TwoFloats__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_package__msg__TwoFloats(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_package, msg, TwoFloats)() {
