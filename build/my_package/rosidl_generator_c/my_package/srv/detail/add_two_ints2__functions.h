...
#ifndef MY_PACKAGE__SRV__DETAIL__ADD_TWO_INTS2__FUNCTIONS_H_
#define MY_PACKAGE__SRV__DETAIL__ADD_TWO_INTS2__FUNCTIONS_H_
...
/// Initialize srv/AddTwoInts2 message.
/**
...
/// Finalize srv/AddTwoInts2 message.
/**
...
/// Create srv/AddTwoInts2 message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * my_package__srv__AddTwoInts2_Request__init().
...
/// Destroy srv/AddTwoInts2 message.
/**
 * It calls
 * my_package__srv__AddTwoInts2_Request__fini()
...
/// Check for srv/AddTwoInts2 message equality.
/**
...
/// Copy a srv/AddTwoInts2 message.
/**
...
/// Initialize array of srv/AddTwoInts2 messages.
/**
...
/// Finalize array of srv/AddTwoInts2 messages.
/**
 * It calls
 * my_package__srv__AddTwoInts2_Request__fini()
...
/// Create array of srv/AddTwoInts2 messages.
/**
 * It allocates the memory for the array and calls
 * my_package__srv__AddTwoInts2_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/AddTwoInts2 messages.
/**
 * It calls
 * my_package__srv__AddTwoInts2_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/AddTwoInts2 message array equality.
/**
...
/// Copy an array of srv/AddTwoInts2 messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * my_package__srv__AddTwoInts2_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_my_package
...
/**
 * It calls
 * my_package__srv__AddTwoInts2_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_my_package
...
/**
 * It allocates the memory for the array and calls
 * my_package__srv__AddTwoInts2_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_my_package
...
/**
 * It calls
 * my_package__srv__AddTwoInts2_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * my_package__srv__AddTwoInts2_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_my_package
...
/**
 * It calls
 * my_package__srv__AddTwoInts2_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_my_package
...
/**
 * It allocates the memory for the array and calls
 * my_package__srv__AddTwoInts2_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_my_package
...
/**
 * It calls
 * my_package__srv__AddTwoInts2_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MY_PACKAGE__SRV__DETAIL__ADD_TWO_INTS2__FUNCTIONS_H_
