...
#include "my_package/msg/detail/two_floats__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_package::msg::TwoFloats & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_package::msg::TwoFloats & ros_message)
{
  // Member: first_number
  cdr >> ros_message.first_number;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_package::msg::TwoFloats;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_package::msg::TwoFloats *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_package::msg::TwoFloats *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TwoFloats__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const my_package::msg::TwoFloats *>(
...
static size_t _TwoFloats__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TwoFloats(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TwoFloats__callbacks = {
  "my_package::msg",
  "TwoFloats",
...
static rosidl_message_type_support_t _TwoFloats__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TwoFloats__callbacks,
...
{
  return &my_package::msg::typesupport_fastrtps_cpp::_TwoFloats__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_package, msg, TwoFloats)() {
  return &my_package::msg::typesupport_fastrtps_cpp::_TwoFloats__handle;
}
